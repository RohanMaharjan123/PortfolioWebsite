        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0">
              Designing outstanding digital experiences with cutting-edge web technologies. Experienced in developing
              scalable full-stack applications using PostgreSQL, Django, React, and Node.js.
            </p>
            <div className="flex justify-center lg:justify-start space-x-4 mb-8">
              <a
                href="https://github.com/RohanMaharjan123"
              ...
              <a
                href="https://www.linkedin.com/in/rohan-maharjan2/"
                className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
              ...
              <a
                href="mailto:nahor.uzamaki@gmail.com"
                className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
          ...
          >
            <div className="relative w-72 h-72 md:w-96 md:h-96 mx-auto">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src="https://wgfyvfhewtfk3thy.public.blob.vercel-storage.com/Screenshot%202025-02-18%20at%205.14.40%E2%80%AFPM-FBzS6fbiamLoS2KEee0TC9ciEJmBrc.png"
                  alt="Rohan Maharjan"
                  width={384}
                  height={384}
                  ...
                  priority
                  onError={(e) => {
                    e.currentTarget.src = "/placeholder.svg?height=384&width=384"
                  }}
                />
              </div>
            </div>
